...
void ComputeKleene(ComputeWord&& compute_word, KernelContext* ctx, const ArrayDataBase& left,
                   const ArrayDataBase& right, ArrayDataBase* out) {
...
inline Bitmap GetBitmap(const ArrayDataBase& arr, int index) {
...
struct InvertOp {
  ...
  static Status Call(KernelContext* ctx, const ArrayDataBase& in, ArrayDataBase* out) {
...
struct Commutative {
  static Status Call(KernelContext* ctx, const Scalar& left, const ArrayDataBase& right,
                     ArrayDataBase* out) {
...
struct AndOp : Commutative<AndOp> {
  ...
  static Status Call(KernelContext* ctx, const ArrayDataBase& left, const Scalar& right,
                     ArrayDataBase* out) {
    if (right.is_valid) {
      checked_cast<const BooleanScalar&>(right).value
  ...
  static Status Call(KernelContext* ctx, const ArrayDataBase& left, const ArrayDataBase& right,
                     ArrayDataBase* out) {
